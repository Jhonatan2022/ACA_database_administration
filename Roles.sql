CREATE ROLE 'empleado';  -- permisos limitados (solo lectura)
CREATE ROLE 'gerente';  -- permisos completos para gestionar datos


GRANT SELECT ON tendadb.* TO 'empleado';  -- Permite solo lectura de la BD
GRANT SELECT, INSERT, UPDATE, DELETE ON tiendadb.* TO 'gerente';  -- Permite leer, insertar, actualizar y eliminar datos en la BD
...
FLUSH PRIVILEGES;  -- Recarga los privilegios para que los cambios tomen efecto
